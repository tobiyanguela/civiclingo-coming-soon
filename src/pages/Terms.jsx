      ...
      <div className="legal-card">
        ...
        <section>
          ...
          <ul>
            ...
            <li>Report safety concerns involving minors immediately to <a href="mailto:safety@civiclingo.com">safety@civiclingo.com</a>.</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul>
            ...
            <li><strong>Parental access:</strong> Parents or guardians of minor users may request full review, modification, or deletion of their child's account and data at any time by contacting <a href="mailto:privacy@civiclingo.com">privacy@civiclingo.com</a>.</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p>To exercise any parental control right, contact us at <a href="mailto:privacy@civiclingo.com">privacy@civiclingo.com</a> with subject line "Parental Control Request" and provide verification of your relationship to the minor account holder. We respond to all parental requests within 5 business days.</p>
        </section>
        ...
        <section>
          ...
          <h3>8.5 Reporting</h3>
          <p>Report violations — especially any safety concerns involving minor users — through the in-app reporting feature or by emailing <a href="mailto:safety@civiclingo.com">safety@civiclingo.com</a>. We respond to all reports within 48 hours, and to reports involving minors within 24 hours.</p>
        </section>
        ...
        <section>
          ...
          <p>To report a security vulnerability, contact <a href="mailto:security@civiclingo.com">security@civiclingo.com</a>. We take all security reports seriously and respond within 24 hours.</p>
        </section>
          ...
          <div className="legal-table">
            <table>
              <tbody>
                ...
                <tr><td>Security vulnerabilities</td><td><a href="mailto:security@civiclingo.com">security@civiclingo.com</a></td></tr>
                <tr><td>Legal & disputes</td><td><a href="mailto:legal@civiclingo.com">legal@civiclingo.com</a></td></tr>
                <tr><td>Billing</td><td><a href="mailto:billing@civiclingo.com">billing@civiclingo.com</a></td></tr>
